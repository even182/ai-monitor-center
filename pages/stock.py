...
定位: 電力與液冷核心""",
        ...
        (
            "2382",
            "廣達",
            """NVIDIA AI Server 最大代工廠。
定位: AI 伺服器核心""",
        ),
        (
            "2317",
            "鴻海",
            """GB200／GB300 AI Server 核心組裝廠。
定位: AI 伺服器組裝""",
        ),
        (
            "3017",
...
定位: 液冷模組核心""",
        ...
        (
            "2383",
            "台光電",
            """Low DK / Low CTE 高速材料龍頭。
定位: 高速材料核心""",
        ),
        (
            "3665",
            "貿聯-KY",
            """AI Server 高速線材與連接器龍頭。
定位: 高速互連核心""",
        ),
        (
            "2474",
...
定位: AI 高速交換器""",
    ...
    "玻纖布": [
        (
            "1802",
            "台玻",
            """原本是傳統玻璃股，現已轉型為 AI 高階玻纖布供應商。受惠 Low DK、Low CTE 缺貨與玻璃基板題材。市場人氣最高。
定位: AI玻纖布 / 玻璃基板""",
        ),
        (
            "1815.TWO",
            "富喬",
            """AI 受惠最純。切入 Low DK / Low CTE 高速材料，直接受惠 AI 伺服器、800G、1.6T 升級。市場視為 AI 材料核心股。
定位: 高階玻纖布""",
        ),
        (
            "5340.TWO",
            "建榮",
            """與日系材料供應鏈連結深，具技術背景優勢。市場關注度較低，偏補漲型。
定位: 高階玻纖布 / 日系供應鏈""",
        ),
        (
            "5475.TWO",
            "德宏",
            """下一代 AI 高速平台概念股。市場聚焦石英布與 Rubin、M9 等高速傳輸材料。未來夢最大，但目前仍偏題材期。
定位: 石英玻纖布""",
        ),
    ]
}
...
if page_mode == "市值排行前五":
...
elif page_mode == "NVIDIA MGX 核心供應鏈":
    render_rank_page(
        title="NVIDIA MGX 核心供應鏈",
        stock_list=CONCEPT_STOCKS.get("NVIDIA MGX 核心供應鏈", []),
        key_prefix="concept_mgx",
    )
    ...
    render_rank_page(
        title="玻纖布",
        stock_list=CONCEPT_STOCKS.get("玻纖布", []),
        key_prefix="concept_fiberglass",
    )
...
- **NVIDIA MGX 核心供應鏈 / AI 測試四大天王 / 石英元件 / 液冷散熱 / Starlink／低軌衛星 / 光通訊矽光子 / 玻纖布**：概念股監控清單，中文名稱旁的 i 可查看個股註解。
- **自選股監測**：輸入股票代碼查詢個股估值。
